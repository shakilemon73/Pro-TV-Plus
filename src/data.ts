...
export const POPULAR_CHANNELS: Channel[] = [
  ...
  },
  {
    id: 'TSN-HD',
    name: 'TSN HD',
    logoUrl: 'https://www.advanced-television.com/wp-content/uploads/2024/09/TSNcanada.png',
    streamUrl: 'http://85.237.89.160:9590/usa-s/TSN-HD-1/index.m3u8',
    category: 'sports',
    isLive: true,
    nowPlaying: 'FIFA World Cup 2026 semifinal match between France and Spain',
    nowPlayingDetails: 'Dallas Stadium in Arlington, Texas. Comprehensive live coverage and expert analysis.',
    nextPlaying: ' France and Spain - FIFA World Cup 2026',
  ...
  },
  {
    ...
    streamUrl: 'http://starhub.pro/live/farhat-3379/67897-913379/89.ts',
    category: 'sports',
    isLive: true,
    nowPlaying: 'FIFA World Cup 2026 semifinal match between France and Spain',
